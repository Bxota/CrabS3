...
import { faArrowsDownToLine, faAt, faClockRotateLeft, faFileCode, faFileImage, faFileText, faKey, faPaperPlane, faPen } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="lg:w-150 w-full mt-5 flex flex-col border-zinc-200 dark:border-zinc-700 border-2 rounded-2xl p-6 bg-white shadow-zinc-100 shadow dark:shadow-zinc-600 dark:bg-zinc-900 transition duration-300">
          ...
          <div className="mt-2 grid grid-cols-1 md:grid-cols-4 gap-4 grid-rows-auto">
            <div className="flex flex-col gap-1 col-span-2">
              ...
              <div className='inputClass h-8 text-lg bg-[#fafafa] dark:bg-[#1c1d21] hover:bg-[#25272c] border-[#e9ebed]! dark:border-[#383a42]! rounded-md px-2 text-zinc-700! dark:text-[#d2d5da]! transition duration-300'>
            ...
            <div className="flex flex-col col-span-2 gap-1">
              <label htmlFor="emailSender" className="text-zinc-700 dark:text-zinc-300">Notify me by email (optional)</label>
              <div className='inputClass h-8 text-lg bg-[#fafafa] dark:bg-[#1c1d21] hover:bg-[#25272c] border-[#e9ebed]! dark:border-[#383a42]! rounded-md px-2 text-zinc-700! dark:text-[#d2d5da]! transition duration-300'>
            ...
            <div className="flex flex-col col-span-2 gap-1">
              <label htmlFor="emailRecipient" className="text-zinc-700 dark:text-zinc-300">Email of recipient (optional)</label>
              <div className='inputClass h-8 text-lg bg-[#fafafa] dark:bg-[#1c1d21] hover:bg-[#25272c] border-[#e9ebed]! dark:border-[#383a42]! rounded-md px-2 text-zinc-700! dark:text-[#d2d5da]! transition duration-300'>
            ...
            {fileMeta.length > 0 && <div className='col-span-4 flex flex-wrap justify-between border-t-2 border-zinc-300 dark:border-zinc-700 pt-4 mt-2'>
              ...
              <div className='w-full mt-4 flex gap-2'>
                ...
                <button
                  ...
                  className="bg-zinc-400 hover:bg-zinc-500 text-white font-semibold py-2 px-4 rounded-lg transition disabled:opacity-50"
                  disabled={uploading || files.length === 0}
                >
                  Clear
                </button>
